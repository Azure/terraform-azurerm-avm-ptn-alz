#!/usr/bin/env pwsh
# Sets up the environment for tflint of the specify-intermediate-root-management-group-on-destroy example.
...
[System.IO.File]::WriteAllText($tfvarsPath, ('prefix = "{0}"' -f $randomPrefix) + "`n")
